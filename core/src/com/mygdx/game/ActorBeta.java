 ...
 */
public class ActorBeta extends Actor implements Pool.Poolable {
    ...
    //THESE VARIABLES WERE CHANGED TO PROTECTED
    ...
    public void setTextureRegion(TextureRegion tr){
        textureRegion = tr;
        rectangle.setSize(textureRegion.getRegionWidth(), textureRegion.getRegionHeight());
    }
    ...
    public boolean isAnimationFinished() { return false;}//animation.isAnimationFinished(elapsedTime); }
    ...
    public void setBoundaryRectangle()
    {
        ...
        float [] vertices = {0, 0, w, h, 0, h, w, 0};
        boundaryPolygon = new Polygon(vertices);
    }

    public void setBoundaryRectangle(float newX, float newY, float newWidth, float newHeight)
    {
        float [] vertices = {newX, newY, newX+newWidth, newY, newX+newWidth, newHeight, newX, newHeight};
        boundaryPolygon = new Polygon(vertices);
    }
    ...
    //Addition by HErC on Jan 28, 2020
    public Vector2 getAccelerationVec() { return accelerationVec; }

    //Addition by HErC on Jan 28, 2020
    public Vector2 getVelocityVec(){return velocityVec;}
    ...
    @Override
    public void reset() {
        setX(Gdx.graphics.getWidth()+2.0f*getWidth());
    }
}